...
How do I connect to an email server with OAuth 2.0? (4D v18 R6)

Find more information on the [blog post](https://blog.4d.com/connect-your-mail-transporters-with-an-oauth-2-0-token/).
